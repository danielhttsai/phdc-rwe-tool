...
(function () {
  ...
  async function handleApi(method, url, init) {
    ...
    if (path === "/api/ml_forbidden" || path === "/api/did_dml" || path === "/api/its_mlcf" || path === "/api/cc_forest" || path === "/api/sccs_selfmatch") {
