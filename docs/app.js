...
const ALIGN_METHODS = [
  ...
  { key: "ccw", method: "ccw",
    name: { zh: "複製-中斷-加權（clone-censor-weight）", en: "Clone-censor-weight (CCW)" },
...
const ALIGN_ORDER = [
  ...
  { k: "ccw", short: { zh: "複製-中斷-加權", en: "Clone-censor-weight" } },
];
const ALIGN_DEMO = {
  naive: {
...
const BIAS_SCENARIOS = [
  ...
  { s: { zh: "比較「長期<b>規律</b>用藥物X」vs「從不用藥」，暴露定義用整個追蹤期的規律性，追蹤<b>從診斷</b>起算。", en: "Compare '<b>long-term regular</b> drug-X use' vs 'never use', defining exposure by adherence over the whole follow-up, with follow-up from diagnosis." },
    ...
    fix: { zh: "改成<b>用藥那天才算暴露</b>（時變暴露）或<b>複製-中斷-加權</b>來處理規律性與Time Zero，配<b>主動對照</b>，再對<b>健康服藥者效應（healthy-adherer effect）</b>做敏感度分析。", en: "Use <b>time-varying exposure</b> or <b>clone-censor-weight</b> for adherence/time-zero, an <b>active comparator</b>, and a sensitivity analysis for the healthy-adherer effect." }, fixMethod: "ccw" },
