...
(function () {
  ...
  const TITLE = { zh: "真實世界證據與準實驗工具箱：IV · RDD · DiD · PERR · ITS · TiT · CCW · Seq · CCTC · CC · SCCS · ACNU · PNU · NC/PCI · MED · PS · TMLE · GM · TND · PSSA · TreeScan · WCE · Transportability · External control",
                  en: "RWE and Quasi-experimental Toolbox: IV · RDD · DiD · PERR · ITS · TiT · CCW · Seq · CCTC · CC · SCCS · ACNU · PNU · NC/PCI · MED · PS · TMLE · GM · TND · PSSA · TreeScan · WCE · Transportability · External control" };
